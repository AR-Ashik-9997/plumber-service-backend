...
const createService = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const _a = req.body, { serviceDetails } = _a, serviceData = __rest(_a, ["serviceDetails"]);
    const file = req.file;
    const result = yield service_service_1.Services.createService(serviceDetails, serviceData, file);
...
const getAllServices = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield service_service_1.Services.getAllServices(filters, paginationOptions);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
...
const getSingleService = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield service_service_1.Services.getSingleService(id);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
...
const updateSingleService = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const _b = req.body, { serviceDetails } = _b, serviceData = __rest(_b, ["serviceDetails"]);
    const file = req.file;
    const result = yield service_service_1.Services.updateSingleService(id, serviceData, serviceDetails, file);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
